...
with zipfile.ZipFile(sys.argv[1]) as package:
    ...
    assert manager['Name'] == 'Enemy Collision Synchronized - v2.10.1' and manager['Options'][0]['Include'] == ['data']
    ...
    assert manifest['revision'] == 'v2.10.1' and manifest['runtime_verified'] is False
